...
//        public class QueryAuthBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
//        {
//            private readonly IHttpContextAccessor _httpContextAccessor;

//            public QueryAuthBehavior(IHttpContextAccessor httpContextAccessor)
//            {
...
//                if (request is UpdateMemberCommand && !user.HasClaim(c => c.Type == CustomClaims.CanCreate && c.Value == ClaimStates.Yes.ToString()))
//                {
//                    throw new UnauthorizedAccessException("You do NOT have claims for editing.");
//                }
